...
class VictronGx extends utils.Adapter {
    ...
    private async onReady(): Promise<void> {
        ...
        this.log.debug('config mqttUsername: ${this.config.mqttUsername}');
        this.log.debug('config mqttPassword: ${this.config.mqttPassword}');
        this.log.debug('config pollingInterval: ${this.config.pollingInterval}');
